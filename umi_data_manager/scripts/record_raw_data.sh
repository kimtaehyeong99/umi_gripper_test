...
# Data directory: use /workspace/data if available (Docker), else local
if [ -d "/workspace" ]; then
...
echo "  - /umi/gripper_position_controller/commands (Gripper Action)"
echo "  - /umi/joint_states (Gripper Observation)"
echo ""
